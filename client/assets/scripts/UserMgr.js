cc.Class({
    ...
    guestAuth:function(){
        ...
        if(cc.args["uid"] !== undefined){
            cc.vv.userMgr.userId = cc.args["uid"];
            cc.args["userName"] = cc.vv.userMgr.userId;
            ...
            if(cc.LOCALHOST){
                ...
                cc.vv.userMgr.userId = num.toString();
                cc.args["uid"] = cc.vv.userMgr.userId;
                cc.args["userName"] = cc.vv.userMgr.userId;
                if(cc.args["gameId"] == undefined){
                    cc.args['gameId'] = cc.LocalGameId;
                }
        ...
        cc.vv.http.sendRequest("/guest",{account:cc.args["uid"]},this.onAuth);
    },
